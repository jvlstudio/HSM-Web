...
<h1 class="title">
	Revistas &bull; <?php echo minimumLabel($info->name, 20);?> 
		...
		<ul class="datas">
			<li class="data">
				...
				<ul class="images">
					<li class="ios">
						<?php if($info->picture): ?>
						<img src="<?php echo HOST;?>/uploads/magazines/<?php echo $info->picture?>" alt="" />
						<p>140x x 190px</p>
						<?php else: ?>
						<p>Sem imagem</p>
						<?php endif; ?>
			...
			<li class="data">
				<h5 class="downtitle">Edição</h5>
				<h5 class="downvalue"><span><?php echo $info->name;?></span></h5>
			</li>
			<li class="data">
				<h5 class="downtitle">Período</h5>
