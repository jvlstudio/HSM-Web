...
<h1 class="title">Passes &bull; <?php echo minimumLabel($info->name, 30);?> <span class="action_plus" page="add-passes/<?php echo $args->id;?>"></span></h1>
...
<div id="boxes">
	...
	<div class="box">
		...
		<div class="edit"><div class="icon" page="edit-passes/<?php echo $obj->id;?>"></div>
		</div>
		<div class="clear"></div>
	</div>
	<?php 
