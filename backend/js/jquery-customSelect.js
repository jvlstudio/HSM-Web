			...
			if(typeof document.body.style.maxHeight !== "undefined"){ /* filter out <= IE6 */
				...
				return this.each(function() {
					var
						...
						customSelectSpan = $('<span class="customSelect" />').append(customSelectInnerSpan).append("<div class=\"favicon\"><i class=\"fa fa-sort\"></i></div>");
					$this.after(customSelectSpan);
					
					customSelectSpan.attr("id", "span_"+$(this).attr("id"));
